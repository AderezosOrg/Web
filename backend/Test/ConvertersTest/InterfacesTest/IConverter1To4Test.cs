...
{
    public class IConverter1To4Tests
    {
        ...
        private readonly Mock<IConverter1To4<ExampleInput1, ExampleInput2, ExampleInput3, ExampleInput4, ExampleOutput>> _mockConverter;
        ...
        public IConverter1To4Tests()
        {
            _mockConverter = new Mock<IConverter1To4<ExampleInput1, ExampleInput2, ExampleInput3, ExampleInput4, ExampleOutput>>();
        ...
        {
            // Act
            var result = _mockConverter.Object.Convert(_validInput1, _validInput2, _validInput3, _validInput4);
        ...
        public void Convert_EmptyInputs_ReturnsDefaultOutput()
        {
            ...
            _mockConverter.Setup(c => c.Convert(emptyInput1, emptyInput2, emptyInput3, emptyInput4))
                          .Returns(expectedEmptyOutput);

            // Act
            var result = _mockConverter.Object.Convert(emptyInput1, emptyInput2, emptyInput3, emptyInput4);
